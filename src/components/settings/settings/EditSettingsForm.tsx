...
const messages = defineMessages({
  ...
  sentryInfo: {
    ...
    defaultMessage:
      'Sending telemetry data allows us to find errors in Aitalk - we will not send any personal information like your message data!',
  },
  hibernateInfo: {
    id: 'settings.app.hibernateInfo',
    defaultMessage:
      'By default, Aitalk will keep all your services open and loaded in the background so they are ready when you want to use them. Service Hibernation will unload your services after a specified amount. This is useful to save RAM or keeping services from slowing down your computer.',
  },
  inactivityLockInfo: {
    id: 'settings.app.inactivityLockInfo',
    defaultMessage:
      'Minutes of inactivity, after which Aitalk should automatically lock. Use 0 to disable',
  },
  lockAfterInactivity: {
  ...
  todoServerInfo: {
    ...
    defaultMessage: 'This server will be used for the "Aitalk Todo" feature.',
  },
  lockedPassword: {
  ...
  lockedPasswordInfo: {
    ...
    defaultMessage:
      "Please make sure to set a password you'll remember.\nIf you loose this password, you will have to reinstall Aitalk.",
  },
  lockInfo: {
    id: 'settings.app.lockInfo',
    defaultMessage:
      'Password Lock allows you to keep your messages protected.\nUsing Password Lock, you will be prompted to enter your password every time you start Aitalk or lock Aitalk yourself using the lock symbol in the bottom left corner or the shortcut {lockShortcut}.',
  },
  ...
  scheduledDNDInfo: {
    ...
    defaultMessage:
      'Scheduled Do-not-Disturb allows you to define a period of time in which you do not want to get Notifications from Aitalk.',
  },
  headlineLanguage: {
  ...
  translationHelp: {
    ...
    defaultMessage: 'Help us to translate Aitalk into your language.',
  },
  spellCheckerLanguageInfo: {
    id: 'settings.app.spellCheckerLanguageInfo',
    defaultMessage:
      "Aitalk uses your Mac's built-in spellchecker to check for typos. If you want to change the languages the spellchecker checks for, you can do so in your Mac's System Preferences.",
  },
  subheadlineCache: {
  ...
  cacheInfo: {
    ...
    defaultMessage: 'Aitalk cache is currently using {size} of disk space.',
  },
  cacheNotCleared: {
  ...
  infoOpenCertificatesFolder: {
    ...
    defaultMessage:
      'To install a certificate, click the button below to open the certificates folder and copy it into the folder. After that you can refresh the service (CTRL/CMD + R). To remove/uninstall, simply delete the certificate file and restart Aitalk.',
  },
            ...
            {this.state.activeSetttingsTab === 'updates' && (
              <div>
                ...
                <p className="settings__message">
                  <Icon icon={mdiGithub} /> Aitalk is based on{' '}
                  <a
