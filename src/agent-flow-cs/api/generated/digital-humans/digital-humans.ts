...
export type generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponseSuccess =
  generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponse200 & {
    headers: Headers;
  };
export type generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponseError =
  generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponse422 & {
    headers: Headers;
  };

export type generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponse =
  | generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponseSuccess
  | generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponseError;
 ...
 */
export const generateDigitalHumanPersonaApiV1DigitalHumansGeneratePost = async (
  digitalHumanGenerateRequest: DigitalHumanGenerateRequest,
  options?: RequestInit,
): Promise<generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponse> => {
  return useCustomInstance<generateDigitalHumanPersonaApiV1DigitalHumansGeneratePostResponse>(
    getGenerateDigitalHumanPersonaApiV1DigitalHumansGeneratePostUrl(),
    {
      ...options,
      method: 'POST',
