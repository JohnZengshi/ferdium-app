...
export const getGetConversationTraceApiV1ChatConversationIdTraceGetUrl = (conversationId: string,
  ...
  return stringifiedParams.length > 0 ? `http://10.0.0.205:8000/api/v1/chat/${conversationId}/trace?${stringifiedParams}` : `http://10.0.0.205:8000/api/v1/chat/${conversationId}/trace`
}
