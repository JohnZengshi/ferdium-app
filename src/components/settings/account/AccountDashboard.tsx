...
const messages = defineMessages({
  ...
  deleteInfo: {
    ...
    defaultMessage:
      "If you don't need your Aitalk account any longer, you can delete your account and all related data here.",
  },
  deleteEmailSent: {
  ...
  yourLicense: {
    ...
    defaultMessage: 'Your Aitalk License:',
  },
  accountUnavailable: {
  ...
  accountUnavailableInfo: {
    ...
    defaultMessage:
      'You are using Aitalk without an account. If you want to use Aitalk with an account and keep your services synchronized across installations, please select a server in the Settings tab then login.',
  },
});
