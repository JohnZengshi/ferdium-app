...
export const bindWhatsappApiV1OwnersSubAccountsUserIdWhatsappBindPost = async (
  userId: string,
  appApiSchemasOwnersWhatsAppBindRequest: AppApiSchemasOwnersWhatsAppBindRequest,
  options?: RequestInit,
...
export type streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponseSuccess =
  streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponse200 & {
    headers: Headers;
  };
export type streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponseError =
  streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponse422 & {
    headers: Headers;
  };

export type streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponse =

    | streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponseSuccess
    | streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponseError;

export const getStreamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetUrl =
  (conversationId: string) => {
 ...
 */
export const streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGet =
  async (
    conversationId: string,
    options?: RequestInit,
  ): Promise<streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponse> => {
    return useCustomInstance<streamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetResponse>(
      getStreamConversationStatusApiV1OwnersConversationsConversationIdStatusStreamGetUrl(
        conversationId,
      ),
      {
        ...options,
