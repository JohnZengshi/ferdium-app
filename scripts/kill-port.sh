...
# Always kill these Aitalk-related ports
...
free_port "$AITALK_SERVER_PORT" "Aitalk internal server"
free_port "$AITALK_TODOS_PORT" "Aitalk todos frontend"
free_port "$AITALK_DEV_API_PORT" "Aitalk dev API"
