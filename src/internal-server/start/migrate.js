...
/**
 * Migrate server database to work with current Aitalk version
 */
...
const migrateLog = text => {
  ...
  console.log('\u001B[36m%s\u001B[0m', 'Aitalk Migration:', '\u001B[0m', text);
};
...
module.exports = async () => {
  ...
  if (user) {
    ...
    migrateLog("🎩  Migrating from old Aitalk version as user doesn't exist");
  ...
  if (
    ...
    // Migrate database to current Aitalk version
