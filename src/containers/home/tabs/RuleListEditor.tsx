      ...
      <div className="flex flex-col gap-y-[20px]">
        {rules.map(rule => {
          ...
          return (
            ...
            >
              <div className="w-[3px] h-[15px] rounded-r-[2px] transition-all duration-150 bg-brand" />
              ...
              <div className="flex-1">
                <div
                  className={`flex h-[40px] items-center rounded-[4px] bg-container transition-all duration-200 hover:border-brand ${
