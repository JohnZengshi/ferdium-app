...
export const getExportCustomerMemoryApiV1MemoryCustomersCustomerIdGetUrl = (customerId: string,
  ...
  return stringifiedParams.length > 0 ? `http://10.0.0.205:8000/api/v1/memory/customers/${customerId}?${stringifiedParams}` : `http://10.0.0.205:8000/api/v1/memory/customers/${customerId}`
}
...
export const getExportCustomerMemoryMarkdownApiV1MemoryCustomersCustomerIdExportMarkdownGetUrl = (customerId: string,
  ...
  return stringifiedParams.length > 0 ? `http://10.0.0.205:8000/api/v1/memory/customers/${customerId}/export/markdown?${stringifiedParams}` : `http://10.0.0.205:8000/api/v1/memory/customers/${customerId}/export/markdown`
}
