...
const messages = defineMessages({
  ...
  workspaceFeatureInfo: {
    ...
    defaultMessage:
      "AITALK Workspaces let you focus on what's important right now. Set up different sets of services and easily switch between them at any time. You decide which services you need when and where, so we can help you stay on top of your game - or easily switch off from work whenever you want.",
  },
  workspaceFeatureHeadline: {
    id: 'settings.workspaces.workspaceFeatureHeadline',
    defaultMessage: 'Less is More: Introducing AITALK Workspaces',
  },
});
