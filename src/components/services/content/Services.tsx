...
const messages = defineMessages({
  ...
  login: {
    id: 'services.login',
    defaultMessage: 'Please login to use Aitalk.',
  },
  serverless: {
    id: 'services.serverless',
    defaultMessage: 'Use Aitalk without an Account',
  },
  serverInfo: {
    id: 'services.serverInfo',
    defaultMessage:
      'Optionally, you can change your Aitalk server by clicking the cog in the bottom left corner. If you are switching over (from one of the hosted servers) to using Aitalk without an account, please be informed that you can export your data from that server and subsequently import it using the Help menu to resurrect all your workspaces and configured services!',
  },
});
