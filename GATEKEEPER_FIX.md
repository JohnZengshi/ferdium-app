...
修复完成后，从启动台或 Applications 文件夹启动 AITALK。
...
1. ✅ **代码签名** - AITALK 有 (Apple Development 签名)
2. ❌ **公证 (Notarization)** - AITALK 没有 (需要 $99/年的开发者账号)
...
3. **完全重置**
   ```bash
   # 删除应用
   rm -rf /Applications/AITALK.app
   rm -rf ~/.Trash/AITALK.app
   
   # 重新安装 DMG
   open ~/Documents/LZXL/ais/ferdium-app/out/AITALK-mac-7.1.3-nightly.3-x64.dmg
