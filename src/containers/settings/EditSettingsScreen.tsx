...
const messages = defineMessages({
  autoLaunchOnStart: {
    ...
    defaultMessage: 'Launch Aitalk on start',
  },
  ...
  runInBackground: {
    ...
    defaultMessage: 'Keep Aitalk in background when closing the window',
  },
  startMinimized: {
  ...
  confirmOnQuit: {
    ...
    defaultMessage: 'Confirm when quitting Aitalk',
  },
  enableSystemTray: {
    id: 'settings.app.form.enableSystemTray',
    defaultMessage: 'Always show Aitalk in System Tray',
  },
  enableMenuBar: {
    id: 'settings.app.form.enableMenuBar',
    defaultMessage: 'Always show Aitalk in Menu Bar',
  },
  reloadAfterResume: {
    id: 'settings.app.form.reloadAfterResume',
    defaultMessage: 'Reload Aitalk after system resume',
  },
  ...
  minimizeToSystemTray: {
    ...
    defaultMessage: 'Minimize Aitalk to system tray',
  },
  closeToSystemTray: {
    id: 'settings.app.form.closeToSystemTray',
    defaultMessage: 'Close Aitalk to system tray',
  },
  ...
  useTouchIdToUnlock: {
    ...
    defaultMessage: 'Allow using TouchID to unlock Aitalk',
  },
  inactivityLock: {
  ...
  enableGlobalHideShortcut: {
    ...
    defaultMessage: 'Enable Global shortcut to hide Aitalk',
  },
  beta: {
  ...
  enableTodos: {
    ...
    defaultMessage: 'Enable Aitalk Todos',
  },
  ...
  restartDialogTitle: {
    ...
    defaultMessage: 'Aitalk - Relaunch Application',
  },
  restartNow: {
  ...
  restartDialogMessage: {
    ...
    defaultMessage: 'Do you want to relaunch Aitalk?',
  },
  restartDialogDetail: {
    id: 'settings.app.restart.restartDialogDetail',
    defaultMessage:
      'You made a change that requires a restart. This will close Aitalk and restart it.',
  },
  sandboxServices: {
