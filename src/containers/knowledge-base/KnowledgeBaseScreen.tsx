...
class KnowledgeBaseScreen extends Component {
  render(): ReactElement {
    return (
      <div className="knowledge-base-screen flex flex-1 flex-col items-center justify-center bg-[var(--bg-primary,#111111)] text-[var(--text-primary,rgba(255,255,255,0.9))] p-[40px]">
        <Icon
