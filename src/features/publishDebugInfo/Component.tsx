...
const messages = defineMessages({
  ...
  info: {
    ...
    defaultMessage:
      "Publishing your debug information helps us find issues and errors in Aitalk. By publishing your debug information you accept Aitalk Debugger's privacy policy and terms of service",
  },
  error: {
