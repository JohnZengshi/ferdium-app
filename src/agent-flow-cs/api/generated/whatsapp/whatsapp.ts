...
export type triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponseSuccess =
  triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponse202 & {
    headers: Headers;
  };
export type triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponseError =
  triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponse422 & {
    headers: Headers;
  };

export type triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponse =
  | triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponseSuccess
  | triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponseError;

export const getTriggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostUrl = (
  sessionId: string,
) => {
 ...
 */
export const triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPost = async (
  sessionId: string,
  options?: RequestInit,
): Promise<triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponse> => {
  return useCustomInstance<triggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostResponse>(
    getTriggerHistorySyncApiV1WhatsappSyncHistorySessionIdPostUrl(sessionId),
    {
      ...options,
      method: 'POST',
    },
